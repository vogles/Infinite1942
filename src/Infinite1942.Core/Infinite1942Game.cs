...
namespace Infinite1942
{
    public class Infinite1942Game : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            //_shipEffect.World = Matrix.Identity;
            ...
            _shipTransform = new Transform();
            _shipTransform.Translate(new Vector3(0, -5, -10));
        }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            DrawModel(_shipModel, _shipTransform.WorldMatrix, view, projection);
            //_shipEffect.World = _shipTransform.WorldMatrix;
